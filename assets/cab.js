...
function init () {
  ...
  for (var i = 0; i < m; i++) for (var j = 0; j < n; j++) T[i][j] = Math.floor(6*Math.random());
}
...
function selektion (x1, y1, x2, y2) {
  if ((T[x1][y1] != 0) && (T[x2][y2] != 0) && (T[x1][y1] != T[x2][y2])) {
    ...
    if ((T[x1][y1] == 1) && (T[x2][y2] == 3)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 1) && (T[x2][y2] == 4)) T[x1][y1] = 0; else
    if ((T[x1][y1] == 1) && (T[x2][y2] == 5)) T[x1][y1] = 0; else

    if ((T[x1][y1] == 2) && (T[x2][y2] == 3)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 2) && (T[x2][y2] == 4)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 2) && (T[x2][y2] == 5)) T[x1][y1] = 0; else
    if ((T[x1][y1] == 2) && (T[x2][y2] == 1)) T[x1][y1] = 0; else

    if ((T[x1][y1] == 3) && (T[x2][y2] == 4)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 3) && (T[x2][y2] == 5)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 3) && (T[x2][y2] == 1)) T[x1][y1] = 0; else
    if ((T[x1][y1] == 3) && (T[x2][y2] == 2)) T[x1][y1] = 0; else

    if ((T[x1][y1] == 4) && (T[x2][y2] == 5)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 4) && (T[x2][y2] == 1)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 4) && (T[x2][y2] == 2)) T[x1][y1] = 0; else
    if ((T[x1][y1] == 4) && (T[x2][y2] == 3)) T[x1][y1] = 0; else

    if ((T[x1][y1] == 5) && (T[x2][y2] == 1)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 5) && (T[x2][y2] == 2)) T[x2][y2] = 0; else
    if ((T[x1][y1] == 5) && (T[x2][y2] == 3)) T[x1][y1] = 0; else
    if ((T[x1][y1] == 5) && (T[x2][y2] == 4)) T[x1][y1] = 0;
  }
}
