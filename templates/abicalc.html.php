            ...
            <div class="col">
                <div class="row">
                    <div class="col-medium-2 col-4">
                        ...
                        <h4 class="p-heading--2"><strong><?= $_SESSION['course'] ?? 0 ?>/600</strong><br>Kurse</h4>
                    </div>
                    <div class="col-medium-2 col-4">
                        <hr class="p-rule--highlight">
                        <h4 class="p-heading--2"><strong><?= $_SESSION['exam'] ?? 0 ?>/300</strong><br>Prüfungen</h4>
                    </div>
                    <div class="col-medium-2 col-4">
                        <hr class="p-rule--highlight">
            ...
            <?php if (isset($_SESSION['course']) and isset($_SESSION['exam'])): ?>
                <div class="p-strip">
                    <div class="p-article-pagination">
                        <button type="submit" name="calc_course" disabled
                                class="p-article-pagination__link--previous p-button is-disabled u-hide">
                            <span class="p-article-pagination__label">Neustart</span>
                            <span class="p-article-pagination__title">Kursblock berechnen</span>
                        </button>

                        <button type="submit" form="reset" name="calc_reset"
                                class="p-article-pagination__link--next p-button">
                            <span class="p-article-pagination__label">Neustart</span>
            ...
            <div class="row">
                ...
                <div class="col">
                    <form method="post" class="p-form p-form--stacked">
                        <div class="col-12">
                            <div class="p-notification--positive">
                                <div class="p-notification__content">
                                    ...
                                    <p class="p-notification__message">Wenn noch nicht alle Notenpunkte bekannt sind,
                                        gib bitte einen Wert an, den du für wahrscheinlich hältst. Nur mit vollständigen
                                        Angaben kann die Berechnung erfolgen.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row--25-25-25-25">
                                        <?php for ($i = 1; $i <= 4; $i++): ?>
                                            <div class="col">
                                                ...
                                                <input type="number" min="0" max="15" maxlength="2" id="<?= "$pi-$i" ?>"
                                                       name="<?= "$pi-$i" ?>" required>
                                            </div>
                                        <?php endfor; ?>
                                    </div>
                        ...
                        <div class="p-strip">
                            <div class="p-article-pagination">
                                <button type="submit" form="reset" name="calc_course" disabled
                                        class="p-article-pagination__link--previous p-button is-disabled">
                                    <span class="p-article-pagination__label">Neustart</span>
                                    <span class="p-article-pagination__title">Kursblock berechnen</span>
                                </button>
                                <button type="submit" name="calc_course"
                                        class="p-article-pagination__link--next p-button">
        ...
        <section class="p-section" id="examblock">
            <div class="row">
                ...
                <div class="col">
                        ...
                        <?php foreach ($exams as $exam): ?>
                            <div class="p-form__group row--25-75">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" min="0" max="15" maxlength="2" id="<?= $ci ?>"
                                           name="<?= $ci ?>" required>
                                </div>
                            </div>
                            <hr class="u-hide--small">
                    ...
                    <div class="p-strip">
                        <div class="p-article-pagination">
                            <button type="submit" name="calc_reset" form="reset"
                                    class="p-article-pagination__link--previous p-button p-button--base">
                                <span class="p-article-pagination__label">Neustart</span>
                                <span class="p-article-pagination__title">Kursblock berechnen</span>
                            </button>
                            <button type="submit" name="calc_exam" form="exams"
                                    class="p-article-pagination__link--next p-button">
